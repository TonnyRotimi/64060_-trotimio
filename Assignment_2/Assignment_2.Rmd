...
```{r}
set.seed(123) 
Temp_data=createDataPartition(Universal$Income,p=0.60, list=FALSE)
```
...
```{r}
set.seed(123) 
Temp_data=createDataPartition(Universal_1$Income,p=0.8, list=FALSE)
```
...
```{r}
set.seed(123) 
Train_data=createDataPartition(Temp$Income,p=0.625, list=FALSE)
```
Training dataset
```{r}
